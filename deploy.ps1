...
$remoteCmd = "mkdir -p ~/deploy_tmp && tar -xzf /tmp/$ArchiveName -C ~/deploy_tmp && sudo mkdir -p /var/www/html/borne /var/www/html/tel /var/www/html/sursitrack /var/www/html/auditreq /var/www/html/speed /var/www/html/slot /var/www/html/alice && sudo cp -r ~/deploy_tmp/apps/borne/dist/* /var/www/html/borne/ && sudo cp -r ~/deploy_tmp/apps/voip-android/dist/* /var/www/html/tel/ && sudo cp -r ~/deploy_tmp/apps/sursitrack/dist/* /var/www/html/sursitrack/ && sudo cp -r ~/deploy_tmp/apps/web/dist/* /var/www/html/auditreq/ && sudo cp -r ~/deploy_tmp/apps/slot-speed/dist/* /var/www/html/speed/ && sudo cp -r ~/deploy_tmp/apps/slotmachine/dist/* /var/www/html/slot/ && sudo cp -r ~/deploy_tmp/apps/slot-wonderland/dist/* /var/www/html/alice/ && sudo cp -r ~/deploy_tmp/apps/powai-home/dist/* /var/www/html/ && sudo chown -R www-data:www-data /var/www/html && rm -rf ~/deploy_tmp /tmp/$ArchiveName && (cd /home/ian/AudiTREQ && pm2 reload all 2>/dev/null || pm2 start ecosystem.config.cjs) && pm2 save && sudo systemctl reload nginx"
